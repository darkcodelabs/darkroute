 ...
 *     See gap record dock-report-bar (pin-drop-haptic-vs-camera-only).
 ...
 * GAP: report-hold-move-slop -- the design specifies the
 ...
 * GAP: report-bar-confirm-dwell -- the design shows the
 ...
 * GAP: dock-v2 / pin-drop-confirmation-is-undrawn-in-v2.
 */
  ...
  return (
    ...
    >
      ...
      {/* Nothing queued draws nothing: the design only ever renders a non-zero
        ...
        * GAP: empty-and-loading-states-mostly-undrawn
        *
