...
export const V1_OVERLAYS: Readonly<Record<string, ComponentType>> = {
  ...
  detour: DetourOffer,
  /**
   * PEW, the arcade. Raised by the dock's key, and by nothing else.
   *
   * An overlay so that the screenState ladder stands it down structurally: an
   * alert's `saveForAlert` empties the stack and `App` renders no overlay
   * while one is live. See `features/arcade/useArcadeStandDown.ts`.
   */
