 ...
 * micro floor (design gap micro-type-below-stated-floor), so the centre
 ...
 * GAP: report / wedge-start-angle-vs-readout
 */
 ...
 * GAP: report / arc-adjust-is-touch-only-in-the-design
 */
