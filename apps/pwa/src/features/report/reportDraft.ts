 ...
 * GAP: report / facing-label-has-one-drawn-provenance
 */
...
export interface PositionDetailInput {
   ...
   * GAP: report / no-street-name-without-a-reverse-geocode
   */
 ...
 * GAP: report / lane-sentence-derived-from-one-example
 */
 ...
 * GAP: report / make-model-plate-guard-false-positives
 */
 ...
 * GAP: report / queue-line-plural-and-tail-derived
 */
 ...
 * GAP: report / no-blocked-or-failed-state-is-drawn
 */
