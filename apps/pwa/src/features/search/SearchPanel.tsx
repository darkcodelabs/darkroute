 ...
 * `docs/gaps-inbox/search-panel.md` because the difference table needs them
 ...
 * are stale and they are listed in `docs/gaps-inbox/search-panel.md`.)
 *
 * =============================================================================
...
export function SearchPanel({
   ...
   * GAP: docs/gaps-inbox/search-panel.md#8-smaller-contradictions
   */
    ...
    >
      ...
      <div className="fwm-search-field">
        ...
        {/* VOICE IS A PEER, NOT A FALLBACK. Inside the field, at full accent,
            ...
            GAP: docs/gaps-inbox/search-panel.md#e-voice-has-no-recogniser */}
        {showMic ? (
          onVoice === undefined ? (
            ...
            {grouped.map((section) => (
              ...
              >
                ...
                {section.rows.map((row) => (
                  <Row key={row.id} row={row} onPress={press} />
                ))}
              </div>
            ))}
 ...
 */
function Row({ row, onPress }: RowProps): ReactElement {
