 ...
 *              -- plateVault, plateMatches, alerts, trips, reportPhotos,
 *              destinations, the secret settings (including
 *              `plateVault.keyId`), and both non-exportable keys.
...
export const STORED_ITEMS: readonly StoredItem[] = Object.freeze([
  ...
  Object.freeze({
    id: 'destinations',
    label: 'PLACES YOU DROVE TO',
    detail: 'the ones you saved go too. a wipe that kept your addresses would not be a wipe.',
    disposition: 'removed',
  }),
  Object.freeze({
    id: 'reports',
  ...
  Object.freeze({
    ...
    detail:
      'threshold, mode, toggles, and how long places are kept. no plate and no coordinate is ever written here.',
    disposition: 'untouched',
  }),
