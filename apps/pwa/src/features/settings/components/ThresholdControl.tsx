 ...
 * produced.
 *
 * THIS SLIDER IS NO LONGER THE WHOLE RANGE, and it is not meant to be. The
 * engine accepts 25 ft to a mile now, because the map-view panel offers that
 * by owner decision; the ends here stay on the band section 04 draws, because
 * that is the band `settings.css` has detent rules for. A driver who set 25 ft
 * or half a mile from the map panel and then opened this screen gets the
 * measured number and no drawn knob - see `threshold.ts` and the `covered`
 * attribute below.
 */
    ...
    >
      ...
      <div className="fwm-settings-threshold-bar">
        ...
        <input
          ...
          min={ALERT_THRESHOLD_DESIGN_MIN_FT}
          max={ALERT_THRESHOLD_DESIGN_MAX_FT}
