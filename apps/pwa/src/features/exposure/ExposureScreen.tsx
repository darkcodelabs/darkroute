            ...
            <div className="fwm-exposure-tiles">
              ...
              <div className="fwm-exposure-tile">
                ...
                <span className="fwm-exposure-tile-value fwm-data">
                  {summary.allTimePasses === null ? NO_VALUE : String(summary.allTimePasses)}
                </span>
                  ...
                  <li key={`${String(row.atMs)}-${row.cameraId}`}>
                    ...
                    >
                      ...
                      <span className="fwm-exposure-pass-where">
                        <span className="fwm-exposure-pass-place">{row.label ?? NO_VALUE}</span>
                        {/* WHO RUNS IT AND WHERE, under the street. Drawn only
                            when the record said something, so an old pass
                            with no facts keeps its one line. */}
                        {row.operator === null && row.where === null ? null : (
