 ...
 * GAP: offline / db-age-phrase-only-drawn-for-days
 *
 * =============================================================================
 ...
 * GAP: offline / counter-grouping-is-not-localised
 */
 ...
 * GAP: offline / no-cache-and-no-check-are-undrawn
 */
const NEVER_CHECKED =
 ...
 * GAP: offline / cached-but-never-checked-is-undrawn
 */
...
export interface DbAgeWarning {
   ...
   * GAP: offline / no-storage-reason-is-undrawn
   */
