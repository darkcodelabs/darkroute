 ...
 * GAP: zone-audit / export-csv-has-no-sink-on-this-device
 * GAP: zone-audit / the-csv-id-set-still-describes-an-area
 *
...
export interface ZoneAuditScreenProps {
   ...
   * GAP: zone-audit / no-configured-origin-so-the-card-carries-no-domain
   */
