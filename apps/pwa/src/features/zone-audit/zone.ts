 ...
 * GAP: zone-audit / heat-layer-metric-is-not-in-any-store-spatially
 *
 * =============================================================================
 ...
 * value.
 * GAP: zone-audit / radius-selector-is-named-but-never-drawn
 */
 ...
 * GAP: zone-audit / zone-centre-is-the-current-fix
 */
...
export interface ZoneCamera {
   ...
   * GAP: zone-audit / facing-inbound-traffic-is-interpreted-as-facing-the-zone-centre
   */
 ...
 * GAP: zone-audit / zone-coverage-is-tested-at-the-centre-tile-only
 */
 ...
 * cannot express.
 * GAP: zone-audit / owner-buckets-in-b6-overlap-and-ours-cannot
 */
 ...
 * GAP: zone-audit / heat-grid-resolution-is-chosen-not-drawn
 */
 ...
 * no trip owner (gap record log (trip-lifecycle-has-no-owner)).
 * GAP: zone-audit / heat-scope-falls-back-when-no-trip-is-open
 */
 ...
 * GAP: zone-audit / heat-bands-low-medium-heavy-have-no-cut-points
 */
 ...
 * GAP: zone-audit / heat-layer-has-no-drawn-empty-state
 */
 ...
 * GAP: zone-audit / card-place-name-needs-a-geocoder
 */
