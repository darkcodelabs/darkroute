...
describe('the onboarding permission switches', () => {
  it('is a switch, not an unlabelled button, so it reads as pressable', () => {
    ...
    //
    // Scoped to the PERMISSION LIST rather than the screen. The screen also
    // carries the full-screen switch, which is the same control and not a
    // permission - counting every switch on the page would make this test
    // fail whenever an unrelated row is added, which is not what it is for.
