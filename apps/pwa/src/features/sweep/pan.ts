/**
 * PAN - put a thumb on the scope and move it, then recenter.
 *
 * =============================================================================
 * WHAT IT IS FOR
 * =============================================================================
 ...
 *
 * Recentering is the other half and it has to be one obvious action, because a
 ...
 *
 * Pressing RADAR still recenters immediately, for somebody who wants it now.
 */
