 ...
 * invented. Recorded in `docs/gaps-inbox/search-panel.md`.
 *
 * =============================================================================
...
import type { CountLookup, EstimateLookup, RouteOption } from '../search/panel.ts';
...
export interface TopBarProps {
   ...
   */
  readonly onDestination?: ((place: Place) => void) | undefined;
  /**
