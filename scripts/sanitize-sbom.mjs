...
const MESHTASTIC_PROTOBUF_PURL = 'pkg:npm/%40jsr/meshtastic__protobufs@2.8.0';
const MESHTASTIC_PROTOBUF_LICENSE_URL =
  'https://github.com/meshtastic/protobufs/blob/v2.8.0/LICENSE';
const MESHTASTIC_PROTOBUF_RELEASE_URL = 'https://jsr.io/@meshtastic/protobufs@2.8.0';
...
const MANIFEST_IMPORTERS = [
  ...
  { component: '@fwm/desktop', manifest: 'apps/desktop/package.json' },
...
function reconcileMissingLicenses(bom) {
  ...
  if (
    ...
    evidence.components.length !== 216
  ) {
...
function reconcileDependencyGraph(bom) {
  ...
  // The root application aggregates the four pnpm workspace applications;
...
function reconcileMeshtasticProtobufLicense(bom) {
  ...
  component.properties = [
    ...properties,
    {
      ...
      value: 'JSR release metadata plus LICENSE bundled in the exact 2.8.0 tarball',
    },
  ];
}
