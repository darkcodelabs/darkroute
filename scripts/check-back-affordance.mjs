...
async function openIntelCard(page) {
  ...
  // `.fwm-intelv1-card` is the glass pane brief 4 replaced the full sheet's
  // hero with. Same question - did the camera card actually open - asked of the
  // element that exists now.
  return page.evaluate(() => document.querySelector('.fwm-intelv1-card') !== null)
}
