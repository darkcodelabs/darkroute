...
can see, and the panel says so in one line instead of leaving it to be
discovered.
...
figures instead of to unfilter the prop.
...
What is left, and it is deliberate instead of forgotten:
...
What holds them apart, in code instead of in this file:
