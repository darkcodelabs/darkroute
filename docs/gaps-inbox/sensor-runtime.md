...
two should be resolved together instead of by adding an error channel here.
...
shortcut screens must keep their own honest empty states instead of assuming a
