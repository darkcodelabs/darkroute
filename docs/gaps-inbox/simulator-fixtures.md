...
exactly why they need a written decision instead of a default nobody chose.
...
- options:
  ...
  2. Radius 2 (25 tiles). Real headroom at speed: a driver crossing a seam at
     62 mph has the next ring already cached instead of fetching at the edge.
     Nearly three times the requests and the storage.
  3. Make it a function of speed instead of a constant -- read one ring parked,
     ...
     the tile service instead of in a constant.
...
here instead of filed. It did surface one product-shaped fact worth writing
