...
shown side by side before the drive instead of buried in settings. Their
...
[Flock Finder](https://github.com/SimeonOnSecurity) - a different
...
Stated here so the boundary is legible instead of implied:
